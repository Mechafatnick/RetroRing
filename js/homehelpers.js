...
siteDiv.innerHTML = '<div class="siteDiv"><a href="'+SiteArray[i].URL+'"><h2 class="siteName">' + SiteArray[i].NAME +'</h2><p class="siteDes">' + SiteArray[i].Description + '</p></a> </div> <p class="divider"> ---- </p>'
